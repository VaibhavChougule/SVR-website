...
import school2 from "/assets/lab2.jpg";
...
function ProductList() {
  ...
  const productData = [
    { title: 'Robot', img: homeRobotImage, link: "robots for various applications" },
    ...
    { title: 'Education Lab', img: school2, link: "educationLab" },
    // { title: 'Instrumentation Lab', img: school ,link:"Instrumentationlab"},
  ...
  return (
    ...
    >
      <h1
        className={`text-4xl font-bold mb-12 transition-all duration-1000 ease-out ${animateHeading ? 'transform translate-y-0 opacity-100' : 'transform translate-y-20 opacity-0'
